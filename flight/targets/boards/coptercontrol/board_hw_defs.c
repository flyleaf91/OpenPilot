...
static const struct pios_gpio pios_leds_cc[] = {
    [PIOS_LED_HEARTBEAT] = PIOS_HW_LED_DEFINITION(GPIOA, GPIO_Pin_6, true),
};
...
static const struct pios_gpio pios_leds_cc3d[] = {
    [PIOS_LED_HEARTBEAT] = PIOS_HW_LED_DEFINITION_REMAP(GPIOB, GPIO_Pin_3, GPIO_Remap_SWJ_JTAGDisable, true),
};
